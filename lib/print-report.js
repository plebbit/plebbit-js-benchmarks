    ...
    for (const benchmark of benchmarkTypes[benchmarkType]) {
      ...
      if (reportType === 'publish') {
        ...
        if (hasTimePropName(benchmark.subplebbits, 'fetchingIpnsTimeSeconds')) {
          ...
          table[rowName] = {
            runtime: benchmark.runtime,
            benchmark: 'fetch subplebbit ipns',
            median: getMedian(benchmark.subplebbits, 'fetchingIpnsTimeSeconds'),
            average: getAverage(benchmark.subplebbits, 'fetchingIpnsTimeSeconds'),
            success: getSuccessRatio(benchmark.subplebbits, 'fetchingIpnsTimeSeconds')
          }
        ...
        if (hasTimePropName(benchmark.subplebbits, 'fetchingIpfsTimeSeconds')) {
          ...
          table[rowName] = {
            runtime: benchmark.runtime,
            benchmark: 'fetch subplebbit ipfs',
            median: getMedian(benchmark.subplebbits, 'fetchingIpfsTimeSeconds'),
            average: getAverage(benchmark.subplebbits, 'fetchingIpfsTimeSeconds'),
            success: getSuccessRatio(benchmark.subplebbits, 'fetchingIpfsTimeSeconds')
          }
        }
        if (hasTimePropName(benchmark.subplebbits, 'publishChallengeRequestTimeSeconds')) {
          const rowName = getNextRowName()
          table[rowName] = {
            runtime: benchmark.runtime,
            benchmark: 'challenge request',
            median: getMedian(benchmark.subplebbits, 'publishChallengeRequestTimeSeconds'),
            average: getAverage(benchmark.subplebbits, 'publishChallengeRequestTimeSeconds'),
            success: getSuccessRatio(benchmark.subplebbits, 'publishChallengeRequestTimeSeconds')
          }
        }
        ...
        if (hasTimePropName(benchmark.subplebbits, 'publishChallengeAnswerTimeSeconds')) {
          const rowName = getNextRowName()
          table[rowName] = {
            runtime: benchmark.runtime,
            benchmark: 'challenge answer',
            median: getMedian(benchmark.subplebbits, 'publishChallengeAnswerTimeSeconds'),
            average: getAverage(benchmark.subplebbits, 'publishChallengeAnswerTimeSeconds'),
            success: getSuccessRatio(benchmark.subplebbits, 'publishChallengeAnswerTimeSeconds')
          }
        }
